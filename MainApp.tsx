...
useEffect(() => {
  ...
  animate();
    ...
    <ActivityIndicator size="large" color="#1976d2" />
                            ...
                            <Image key={currentItem} source={getCurrentImage()} style={styles.image} />
                        ) : category === "Numbers" ? (
                ...
                <TouchableOpacity
                    onPress={() => Linking.openURL("https://wordica-privacy.netlify.app/")}
...
export const styles = StyleSheet.create({
    ...
    imageContainer: {
        ...
        marginTop: Platform.OS === "ios" ? height * 0.02 : height * 0.03,
        alignItems: "center",
        justifyContent: "center",
        borderRadius: 20,
        overflow: "hidden",
    ...
    topBar: {
        position: "absolute",
        //  top: height * 0.1,
        top: Platform.OS === "ios" ? height * 0.145 : height * 0.11,
        right: width * 0.08,
        zIndex: 10,
        borderWidth: 1,
        borderColor: 'lightgray',
